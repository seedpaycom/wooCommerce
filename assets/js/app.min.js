...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nlet appConfig = {}\n/* harmony default export */ __webpack_exports__[\"default\"] = (appConfig);\n\n\n//# sourceURL=webpack:///./assets/js/appConfig.js?");

/***/ }),

/***/ "./assets/js/processTransaction.js":
/*!*****************************************!*\
  !*** ./assets/js/processTransaction.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _transactionStatus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./transactionStatus */ \"./assets/js/transactionStatus.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (({\n    transaction,\n    errorHandler,\n    transactionAccepted,\n    pendingTransactionHandler,\n}) => {\n    if (!transaction || !transaction.status) return null\n    let status = transaction.status\n    if (status == _transactionStatus__WEBPACK_IMPORTED_MODULE_0__[\"default\"].acceptedAndPaid) {\n        transactionAccepted()\n        return true\n    } else if (status == _transactionStatus__WEBPACK_IMPORTED_MODULE_0__[\"default\"].rejected) {\n        errorHandler('Payment rejected.  Please resubmit the order to try again.')\n    } else if (status == _transactionStatus__WEBPACK_IMPORTED_MODULE_0__[\"default\"].errored) {\n        errorHandler('Payment failed.  Please resubmit the order to try again or contact helpdesk@seedpay.com for assistance.')\n    } else if (status == _transactionStatus__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pending || status == _transactionStatus__WEBPACK_IMPORTED_MODULE_0__[\"default\"].accepting) {\n        pendingTransactionHandler()\n    } else {\n        errorHandler('Unknown transaction status.  Please contact helpdesk@seedpay.com.')\n    }\n    return false\n});\n\n\n//# sourceURL=webpack:///./assets/js/processTransaction.js?");

/***/ }),

/***/ "./assets/js/transactionStatus.js":
/*!****************************************!*\
  !*** ./assets/js/transactionStatus.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n    acceptedAndPaid: 'acceptedAndPaid',\n    accepting: 'accepting',\n    errored: 'errored',\n    pending: 'pending',\n    rejected: 'rejected',\n});\n\n\n//# sourceURL=webpack:///./assets/js/transactionStatus.js?");
