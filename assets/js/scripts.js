jQuery(function($) {
		...
		function seedpay_check_transaction(transaction_id,phone){
			...
			jQuery.post(seedpay_params.ajax_url, {'action':'ajax_seedpay_check_request','transaction_id':transaction_id,'phone':phone}, function(response) {
		...
		$( document ).on( "click", ".seedpay-request-payment-submit", function() {
			...
			jQuery.post(seedpay_params.ajax_url, {'action':'ajax_seedpay_submit_request','phone':phone}, function(response) {
